...
class DynaProtDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        feats["dynamics_means"] = np.load(os.path.join(self.label_dir, f"{protein_id}/dynamics_labels/means.npy"))   # add dynamics labels to dict here (mean, var, ...)
        ...
        # padded_selected_feats["frames"] = torch.tensor([Rigid.from_tensor_4x4(selected_feats["frames"])])  # convert to AlphaFold/OpenFold Rigid object after padding
